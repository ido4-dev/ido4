...
<Tabs>
<TabItem label="Hydro" icon="rocket">
...
<TabItem label="Scrum" icon="list-format">
...
**56 MCP tools** generated from profile.

</TabItem>
<TabItem label="Shape Up" icon="setting">
...
**54 MCP tools** generated from profile.
