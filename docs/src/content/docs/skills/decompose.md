...
> **Visual reference:** See the [Decomposition Pipeline diagram](https://github.com/ido4-dev/ido4/blob/main/diagrams/06-decomposition-pipeline.html) for the full pipeline architecture.
